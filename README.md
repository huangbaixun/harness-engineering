...
[![Version](https://img.shields.io/badge/version-v1.9.1-blue)](CHANGELOG.md)
...
订阅后，新版本发布时 Claude Code 自动提示更新，无需手动操作。
...
# CodeBuddy
codebuddy plugins add harness-engineering
```
...
| `$TOOL_DIR/settings.json` | 权限控制 + Hook 注册（`.claude/` 或 `.codebuddy/`） |
